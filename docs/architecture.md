...
- `ExerciseDemoTest` — shipped name map for Barbell bench press, Dumbbell bench press, Smith bench press, Incline barbell press, Incline Smith bench press, Incline dumbbell press, Pec deck fly, Cable fly, Chest press machine, and Push-up; unknown names have no demo; every built-in seed name has main/auxiliary targets
