...
- `ExerciseDemoTest` — shipped name map for Barbell bench press, Dumbbell bench press, Incline barbell press, and Incline dumbbell press; unknown names have no demo; every built-in seed name has main/auxiliary targets
