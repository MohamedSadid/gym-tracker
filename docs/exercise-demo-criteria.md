...
- Wrong equipment (e.g. incline bench for flat DB press, or a **flat** bench on an incline press)
...
- App copies: `app/src/main/assets/exercises/` — `{slug}_lockout.png`, `{slug}_bottom.png` (and `{slug}.png` loop when it exists) for Barbell bench press, Dumbbell bench press, Incline barbell press, and Incline dumbbell press
