...
- **Demos (first pass):** **Barbell bench press**, **Dumbbell bench press**, **Smith bench press**, **Incline barbell press**, **Incline Smith bench press**, **Incline dumbbell press**, and **Pec deck fly** have lockout/bottom stills (two-frame playback). Other built-ins show the same cards with an empty thumbnail until stills exist. Custom exercises have no demo.
