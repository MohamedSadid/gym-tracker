...
- **Demos (first pass):** **Barbell bench press**, **Dumbbell bench press**, **Smith bench press**, **Incline barbell press**, **Incline Smith bench press**, **Incline dumbbell press**, **Pec deck fly**, **Cable fly**, **Chest press machine**, and **Push-up** have position-1 / position-2 stills (two-frame playback). Other built-ins show the same cards with an empty thumbnail until stills exist. Custom exercises have no demo.
